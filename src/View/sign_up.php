...
<body>
    ...
    <main class="form">
        <div class="container">
            ...
            <form action="../Controller/Client.php?operation=sign_up" method="POST">
                <article class="form__inputs">
                    <label for="name">Nome completo:</label>
                    <input required type="text" name="name" id="name">

                    <label for="birth_date">Data de nascimento:</label>
                    <input required type="date" name="birth_date" id="birth_date"></input>
            ...
            <article class="form__sign_up-or-sign_in">
                <p>Já tem uma conta? <a href="sign_in.php">Entre aqui!</a></p>
            </article>
        </div>
    </main>
